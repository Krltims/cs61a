...
CREATE TABLE pairs AS
  SELECT a.room || " and " || b.room || " together have " || (a.seats+b.seats)  || " seats" from sizes as a, sizes as b where a.room<b.room and (a.seats+b.seats) >= 1000 order by (a.seats+b.seats) desc ;
